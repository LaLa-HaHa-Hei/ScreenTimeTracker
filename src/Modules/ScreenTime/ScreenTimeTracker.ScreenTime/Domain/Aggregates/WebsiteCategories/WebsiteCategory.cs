...
namespace ScreenTimeTracker.ScreenTime.Domain.Aggregates.WebsiteCategories;

public class WebsiteCategory : AggregateRoot
{
...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider adding the 'required' modifier or declaring as nullable.
    ...
    public static WebsiteCategory Create(
    ...
    public static WebsiteCategory Import(string name, string color, string? iconPath) =>
        new(Guid.CreateVersion7(), name, color, iconPath, DateTimeOffset.MinValue, false);

    public static WebsiteCategory CreateUncategorized() =>
