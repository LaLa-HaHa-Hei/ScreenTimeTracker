...
public record AppUsageSessionOptimizationResult(IReadOnlySet<AppUsageSession> SessionsToRemove);

public class AppUsageSessionOptimizer
{
    public static AppUsageSessionOptimizationResult Optimize(
        IReadOnlyList<AppUsageSession> sessions,
    ...
    )
    {
        ...
        return new AppUsageSessionOptimizationResult(sessionsToRemove);
    }
}
