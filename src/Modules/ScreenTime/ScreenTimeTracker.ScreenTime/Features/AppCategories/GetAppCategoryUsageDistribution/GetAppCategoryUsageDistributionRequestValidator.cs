...
public class GetAppCategoryUsageDistributionRequestValidator
    : Validator<GetAppCategoryUsageDistributionRequest>
{
    public GetAppCategoryUsageDistributionRequestValidator()
    {
