...
public class GetAppCategoryUsageTimelineRequestValidator
    : Validator<GetAppCategoryUsageTimelineRequest>
{
    public GetAppCategoryUsageTimelineRequestValidator()
    {
