...
public class GetWebsiteUsageDistributionRequestValidator
    : Validator<GetWebsiteUsageDistributionRequest>
{
    public GetWebsiteUsageDistributionRequestValidator()
    {
