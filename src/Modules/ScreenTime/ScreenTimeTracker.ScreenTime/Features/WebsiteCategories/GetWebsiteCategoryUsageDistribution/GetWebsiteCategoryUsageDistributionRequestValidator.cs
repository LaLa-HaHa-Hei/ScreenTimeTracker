...
public class GetWebsiteCategoryUsageDistributionRequestValidator
    : Validator<GetWebsiteCategoryUsageDistributionRequest>
{
    public GetWebsiteCategoryUsageDistributionRequestValidator()
    {
