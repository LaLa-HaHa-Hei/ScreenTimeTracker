...
public class GetWebsiteCategoryUsageTimelineRequestValidator
    : Validator<GetWebsiteCategoryUsageTimelineRequest>
{
    public GetWebsiteCategoryUsageTimelineRequestValidator()
    {
