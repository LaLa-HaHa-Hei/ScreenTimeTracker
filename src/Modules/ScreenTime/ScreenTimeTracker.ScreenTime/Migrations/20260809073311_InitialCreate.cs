        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Regional_TimeZoneId = table.Column<string>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ScreenTime_Apps_ScreenTime_AppCategories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ScreenTime_Websites_ScreenTime_WebsiteCategories_CategoryId",
                        column: x => x.CategoryId,
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "AllowMetadataAutoRefresh", "CategoryId", "Color", "ExecutablePath", "IconPath", "IconPathLastUpdatedAt", "IsSystem", "MetadataLastRefreshedAt", "Name", "ProcessName" },
                values: new object[,]
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ScreenTime_Apps_CategoryId",
                table: "ScreenTime_Apps",
                column: "CategoryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ScreenTime_Websites_CategoryId",
